...
<style>
#container_title{font-family:'MoskExtraBold800'; font-size:25px; font-weight: bold; margin:5% 2% 0;}
...
<div id="bo_gall">
    ...
    <ul id="gall_ul">
        ...
        ?>
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>" style="width:100%;">
            <?php if ($is_checkbox) { ?>
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text_href" style="font-size:0.85rem;">
                    <?php
