...
<section id="bo_w" style="width:1200px; margin:70px auto;">
	...
	<div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<td>
				...
				$(document).ready(function() {
					$('#ca_name option[value="<?=$ca_s?>"]').attr('selected','selected');
				});
				</script>
				<? } ?>
			</td>
		...
		<tr>
			<th scope="row"><label for="wr_10">동영상 추가</label></th>
			<td>
				<div class="help11 blue">유튜브<!-- 나 다음팟--> 영상의 주소를 붙여넣으면 영상이 본문에 보여집니다.</div>
				<input type="text" name="wr_10" value="<?php echo $write['wr_10'] ?>" id="wr_10" class="frm_input" size="50">
				<span class="help11">예시) http://www.youtube.com/watch?v=9bZkp7q19f0</span>
			</td>
		</tr>
		<tr>
				<th scope="row"><label for="wr_1">상호명</label></th>
				<td><input type="text" name="wr_1" value="<?php echo get_text($write['wr_1']); ?>" id="wr_1" class="frm_input" size="50" maxlength="255"></td>
		</tr>
		<tr>
				<th scope="row"><label for="wr_2">출력순서</label></th>
				<td><input type="number" name="wr_2" value="<?php echo get_text($write['wr_2']); ?>" id="wr_2" class="frm_input" size="50" maxlength="255"></td>
		</tr>
		<tr>
