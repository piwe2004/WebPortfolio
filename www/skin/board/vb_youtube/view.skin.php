...
?>
<link rel="stylesheet" href="<?php echo $board_skin_url ?>/style.css?a=1">
...
.movie_wrap{margin:0 auto; text-align: center;}
.sub_cate{display: none;}
</style>
<article id="bo_v" style="width:1200px; margin:70px auto;">
    <header>
        <h1 id="bo_v_title">
            <?php
    ...
    <section id="bo_v_info">
        ...
        <?php if($view['wr_1']) { ?>
          <strong>
            <span>CLIENT : </span><?php echo $view['wr_1']; ?> &nbsp&nbsp|&nbsp&nbsp
          </strong>
          <?php } ?>
        <strong><span>DIRECTOR : </span><?php echo $view['name'] ?><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?> &nbsp&nbsp|&nbsp&nbsp </strong>
        <strong><span>DATA : </span><?php echo date("Y/m", strtotime($view['wr_datetime'])) ?></strong>
    ...
    <section id="bo_v_atc">
     ...
     <div class="movie_wrap">
		 <?php if($v){ ?>
		 <!-- <iframe width="728" height="450" src="//www.youtube.com/embed/<?php //echo $v; ?>?feature=player_detailpage&vq=hd720&rel=0" frameborder="0" allowfullscreen></iframe> -->
		 <iframe width="980" height="552" src="//www.youtube.com/embed/<?php echo $v; ?>?feature=player_detailpage&vq=hd720&rel=0" frameborder="0" allowfullscreen></iframe>
		 <p></p>
		 <?php } ?>
   </div>
...
<script type="text/javascript">
  ...
  function resizeYoutube(){
	$("iframe").each(function(){
		...
		{
			$(this).css("width","100%"); $(this).css("height",Math.ceil( parseInt($(this).css("width")) * 450 / 728 ) + "px");
		}
	});
  }
</script>
