...
<style>
  .check_box_wrap{ width:100%; margin:0 auto;}
  .check_box_wrap {border-top: none !important;}
 .check_box_wrap label {font-size:1rem;}
  .check_box_wrap label input {margin:1.3% 0; display:inline-block; width:20px; height: 20px; border: 2px solid #666666; cursor: pointer;}
  .check_ip{display:inline-block; width:20px; height: 20px; border: 2px solid #666666; cursor: pointer;}
  .check_box_wrap label  {cursor: pointer;}
  .check_box_wrap label:nth-child(1) {margin:0 10%;}
  .check_box_wrap label:nth-child(2) {margin:0 10%}
  .check_box_wrap label:nth-child(3) {margin:0 12%;}
  .check_box_wrap label:nth-child(4) {margin:0 8.4% 0 10%;}
  .check_box_wrap label:nth-child(5) {-webkit-margin-end:7.2% !important; -webkit-margin-start:10% !important; margin:0 7.6% 0 10%;}
  .check_box_wrap label:nth-child(6) {margin:0 10%;}
  .tbl_frm01 th {border:none !important; color:#018ace;}
  .tbl_frm01 td {border: none !important;}
  .tr_wrap {width:30%; border:none !important; box-sizing: border-box !important;}
  .tr_wrap th {padding-top:50px;}
  .name_wrap {border:none !important; background:none !important; font-size:1.2rem; font-weight: 400;}
  .input_wrap td input{background: none !important; width:90%; height:60px; padding-left:10px;}
  #wr_content{height:170px !important; background:none !important;}
  .wr_content textarea {resize:none;}

  .chap_cha{float:left;}
  .pass_wrap{overflow: hidden; padding-left:50px;}
  .pass_wrap li{margin-bottom: 20px;}
</style>

<!–[if IE]>
<style type="text/css">
 .check_box_wrap label:nth-child(5) {}
</style>
<![endif]–>
    ...
    <section id="fregister_term">
        ...
        <fieldset class="fregister_agree">
            <input class="check_ip" type="checkbox" name="agree" value="1" id="agree">
            <label for="agree">온라인상담약관의 내용에 동의합니다.</label>
        </fieldset>
    </section>
	<?php } ?>

    <div class="tbl_frm01 tbl_wrap" style="border-top:2px solid #000;">
      <div style="overflow:hidden; margin-bottom:50px;">
        <p style="color:#000; font-size:1.4rem; text-align:left; font-weight:700; letter-spacing:1px; margin:1.5% 0;">01.원하는 서비스를 선택해 주세요
          <span style="font-size:0.8rem; color:#666666; font-weight:300; margin-top:10px;">(다중선택가능)</span>
        </p>
      </div>
        <table>
        <tbody>
      		...
      		for ($i=0; $row=sql_fetch_array($result); $i++){
      			...
      			switch($row['type']){
      				case '11':	// 영문이름
      					if($csconfig[$fvs]=='1' || $csconfig[$fvs]=='2'){
      						...
      						echo '<tr><td style="height:70px;"></td></tr>

                  <tr style="border-top:2px solid #000; ">
                    <td colspan="2" style="border-top">
                    <p style="color:#000; font-size:1.4rem; text-align:left; font-weight:700; letter-spacing:1px; margin:1.5% 0;">02. 기본 정보를 입력 해주세요 <span style="font-size:0.8rem; color:#666666; font-weight:300; margin-top:10px;">(필수 입력사항 입니다.)</span>
                    </p>
                    </td>
                    </tr>
                    <tr class="tr_wrap">
      							<th scope="row" class="cs_name name_wrap"><label for="cs_name">상호명</label></th>
      							<th scope="row" class="cs_name name_wrap"><label for="phon_number">휴대폰번호</label></th>
                    </tr>
                    <tr class="input_wrap">
      							<td>
                ...
                case '14':	// 휴대번호
        					if($csconfig[$fvs]=='1' || $csconfig[$fvs]=='2'){
        						...
        						echo '
        							<td>
        								<input type="text" name="N'.$fvs.'" id="N'.$fvs.'" value="'.$write[$fvs].'" '.$required.' class="'.$required.'frm_input" size="'.$mdatas[$fvs][size].'" placeholder="'.$mdatas[$fvs][bigo].'" maxlength="11" onkeydown="return onlyNumber(event)" onkeyup="removeChar(event)" style="ime-mode:disabled;">
        							</td>
                      </tr>';
        					}
                ...
                case '14':	// 휴대번호
        					if($csconfig[$fvs]=='1' || $csconfig[$fvs]=='2'){
        						...
        						echo '<tr>
        							<th scope="row" class="phon_number"><label for="ca_name">'.$mdatas[$fvs]['iname'].$needstr.'</label></th>
        							<td>
        								<input type="text" name="N'.$fvs.'" id="N'.$fvs.'" value="'.$write[$fvs].'" '.$required.' class="'.$required.'frm_input" size="'.$mdatas[$fvs][size].'" placeholder="'.$mdatas[$fvs][bigo].'">
        							</td>
        						</tr>';
		...
		<?php } ?> -->
    <?php if ($is_name && $is_email) { ?>
        <tr class="tr_wrap">
            <th scope="row" class="name_wrap"><label for="wr_name">이름<strong class="sound_only">필수</strong></label></th>
            <th scope="row" class="name_wrap"><label for="wr_email">이메일</label></th>

        </tr>
        <tr class="input_wrap">
            <td><input type="text" name="wr_name" value="<?php echo $name ?>" id="wr_name" required class="frm_input required" size="10" maxlength="20"></td>
            <td><input type="text" name="wr_email" value="<?php echo $email ?>" id="wr_email" class="frm_input email" size="20" maxlength="100"></td>
...
<?php }?>
      ...
      <tr>
        ...
        <tr style="border-top:2px solid #000; margin-top:2%;">
          <th colspan="2" style="background:none; height:10%;">
            <p style="margin:2% 0; color:#000; font-size:1.4rem; text-align:left; font-weight:700; letter-spacing:1px; margin:1.5% 0;">03.상세문의 내용<strong class="sound_only">필수</strong></label>
            </p></th>
          </tr>
          <tr>
        ...
        <div style="overflow:hidden;">
          ...
          <?php if ($is_password) { ?>
          <ul class="pass_wrap">
            <li scope="row"><label for="wr_password">비밀번호<strong class="sound_only">필수</strong></label></li>
