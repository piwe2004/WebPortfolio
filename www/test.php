...
if(!G5_IS_MOBILE){
?>
<link href="/css/pcindex.css?t=18" rel="stylesheet" media="screen and (min-width:641px) and (max-width:1920px)">
<?} else {?>
<link href="/css/moindex.css?t=15" rel="stylesheet" media="screen and (max-width:640px)">
...
$(document).ready(function(){
  $(".open_btn").hover(function(){
    $(".menu_ul_wrap").fadeToggle();
  });
});
...
<div class="main_wrap">
  ...
  <div class="movie_wrap">
    <div class="menu_wrap">
      ...
      <ul class="menu_ul_wrap">
          ...
          <li class="media menu_li"><a href="/sub/media/worth.php" title="미디어페이지로 이동">미디어</a></li>
    ...
    <div class="movie_di">
      <!-- <iframe width="1878" height="1056" vq=highres src="https://www.youtube.com/embed/F5A7BjPY0N0?rel=0&autoplay=0&controls=0&showinfo=0&autohide=0&loop=1" frameborder="0" gesture="media" allowfullscreen></iframe> -->
      <?php
      if(!G5_IS_MOBILE){
      ?>
      ...
      <!-- <video width="100%" autoplay loop="3" poster="/image/main/poster_bg.jpg"> -->
				<!-- <source src="http://bsmov.cafe24.com/movie/BrothersSolution_PR_20171025.mp4" type="video/mp4"> -->
				<!-- <source src="http://bsmov.cafe24.com/movie/BrothersSolution_PR.mp4" type="video/mp4">
			</video> -->
      <?} else {?>
        <video id="my-video" class="video-js" autoplay muted playsinline poster="/image/main/poster_bg.jpg" preload="auto" width="100%"
  ...
  <div class="sec_wrap">
    ...
    <div class="sec_cen_ment">
      ...
      <p class="cen_ment_3">(주)BROTHERS SOLUTION</p>
      <p class="cen_ment_4">(주)브라더스 솔루션은 웹사이트, 모션그래픽, 브랜딩, 모바일 어플리케이션 등<br/>디지털 기반의 다양한 분야에서 활동하는 광고회사 입니다.</br> 우리는 태어난 이유를 찾기 위해 디자인을 하고 창작활동을 합니다.</br>아름답고, 이해하기 쉬우며, 지속 가능한 언어로 디자인합니다. </p>
